            ...
            <div className="slider">
              <div className="sliderWrapper" id="moving-container">
                ...
                <div className="sliderButton">
                  <div className="btnPictureWrapper">
                    <button onClick={() => this.clickMoving(1)}></button>
                    <button onClick={() => this.clickMoving(2)}></button>
                    <button onClick={() => this.clickMoving(3)}></button>
                  </div>
                </div>
              </div>
            </div>
